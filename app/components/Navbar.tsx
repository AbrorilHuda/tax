...
export function Navbar() {
  ...
  return (
    <>
        ...
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="hidden sm:flex items-center justify-center h-9 w-9 rounded-md border border-border bg-secondary text-secondary-foreground transition-all hover:bg-muted hover:glow-border hover:scale-105"
              aria-label="GitHub"
            >
            ...
            <button
              ...
              className="flex md:hidden items-center justify-center h-9 w-9 rounded-md border border-border bg-secondary text-secondary-foreground transition-all hover:bg-muted"
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 z-40 bg-background/95 backdrop-blur-xl transition-all duration-300 md:hidden ${isOpen
